...
HOW TO CUSTOMIZE
  ...
  - Just drop your photos (jpg/png/webp) in the SAME folder as this
    script -- no "photos" subfolder needed. If none are found, an
    uploader appears once the envelope is opened.
"""
...
if not st.session_state.opened:
    ...
    if photo_paths:
        ...
        st.info(
            "No photos found next to this script. "
